...
function buildContent(){
    ...
    <div id="play-container">
        <div id="play-left" class="left">
            <div id="download" >
                <span>Download:</span>
                <div class="first"><a href="<?php echo DOCUMENTS_PATH."Domanda_di_Ammissione.pdf"?>"><img src="img/download.png" class="download-thumbnail" /><span>Domanda di ammissione</span></a></div>
                <div><a href="<?php echo DOCUMENTS_PATH."Mod.Autorizzazione_Trattamento_Dati_Personali.pdf"?>"><img src="img/download.png" class="download-thumbnail" /><span>Autorizzazione al trattamento dei dati personali</span></a></div>
                <div><a href="<?php echo DOCUMENTS_PATH."Regolamento_Interno.pdf"?>"><img src="img/download.png" class="download-thumbnail" /><span>Regolamento interno</span></a></div>
                <div><a href="<?php echo DOCUMENTS_PATH."Scarico_Responsabilita_Minori.pdf"?>"><img src="img/download.png" class="download-thumbnail" /><span>Scarico di responsabilit&agrave per minori</span></a></div>
                <div><a href="<?php echo DOCUMENTS_PATH."Scarico_Responsabilita.pdf"?>"><img src="img/download.png" class="download-thumbnail" /><span>Scarico di responsabilit&agrave</span></a></div>
            </div>
            <div id="contact">
                <span>Contatti:</span>
