...
function buildContent(){
    ...
    <div id="content">
        ...
        <div id="description">
            <p>
              Skorpion SAT nasce il 22 maggio 2012, un Club voluto a tutti i costi dalla cocciutaggine
              della Presidente Elisa <span>&ldquo;Avvocata&ldquo;</span> Milani e dagli altri cinque fondatori che,
              &nbsp;per un forte legame di amicizia, hanno voluto seguirla in questa nuova sfida!
            </p>
            <p class="text-paragraph">
              Nonostante sia nato da poco, il Club vanta
              ...
              di giocare in modo <span>&ldquo;sano&rdquo;</span>.
            </p>
            <p class="text-paragraph">
              Anche i nuovi arrivati,&nbsp;come noi,&nbsp;hanno manifestato sin da
              ...
              organizzare cene o pizzate per stare tutti in compagnia (softgunner e consorti!).
            </p>
            <p class="text-paragraph">
              Non siamo solo un Club di softair, siamo una famiglia dove
              tutti sono alla pari e ognuno ha un ruolo importante e fondamentale
              per l'organizzazione e l'unione della squadra!
            </p>
            <p class="text-paragraph">
               Nella nostra famiglia abbiamo un preparatissimo verniciatore
               ...
               potrete vedere i lavori, o meglio le opere d'arte, che ha creato sino ad ora!
             </p>
            <p class="text-paragraph">
              Ma non &egrave; finita qui!&nbsp;Questo meraviglioso sito secondo voi
              ...
              Senza di lui il world wide web non avrebbe nemmeno saputo della nostra esistenza!
            </p>
            <p class="text-paragraph">
              Come non nominare inoltre il nostro Marco <span>&ldquo;Freaky&rdquo;</span>,
              efficiente responsabile per i provanti, coordinatore e caposquadra durante i nostri game!
              Senza di lui le tattiche sono solo parole! Un leader nato, capace di spronare e dirigere
              alla perfezione i giocatori, senza mai dimenticare che si è prima di tutto amici ma, se si
              conquistano obiettivi e se si prende la bandiera è sempre meglio!
            </p>
            <p class="text-paragraph">
              E dulcis in fundo non poteva mancare all'interno della famiglia una PR,
              fotografa, chef e foodblogger che durante i game ci vizia e delizia
              ...
              sport tra una ricetta e l'altra!
            </p>
            <p class="text-paragraph">
              Questa &egrave; solo una parte della nostra famiglia,
